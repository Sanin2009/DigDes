...
class _ApiClient implements ApiClient {
  ...
  @override
  Future<User?> getUserByName(name) async {
    const _extra = <String, dynamic>{};
  ...
  @override
  Future<List<User>> searchUser(name) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'name': name};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<List<User>> getSubscriptions(subscriberId) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'subscriberId': subscriberId};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result =
        await _dio.fetch<List<dynamic>>(_setStreamType<List<User>>(Options(
  ...
  @override
  Future<List<User>> getSubRequests(userId) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'userId': userId};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<List<ShowCommentModel>> showComments(postId) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'postId': postId};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<ShowCommentModel>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map(
            (dynamic i) => ShowCommentModel.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
  ...
  Future<dynamic> createPost(createPostModel) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(createPostModel.toJson());
    final _result = await _dio.fetch(_setStreamType<dynamic>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
  ...
  @override
  Future<List<Metadatum>> uploadTemp({required files}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _result =
        await _dio.fetch<List<dynamic>>(_setStreamType<List<Metadatum>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    var value = _result.data!
        .map((dynamic i) => Metadatum.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }

  @override
  Future<bool?> updateSettings(settings) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
