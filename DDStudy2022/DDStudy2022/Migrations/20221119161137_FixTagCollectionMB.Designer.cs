...
namespace Api.Migrations
{
    ...
    [Migration("20221119161137_FixTagCollectionMB")]
    partial class FixTagCollectionMB
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PostTagUserPost", b =>
                {
                    ...
                    b.Property<string>("PostTagsTag")
                        .HasColumnType("text");

                    b.Property<Guid>("PostTagsUserPostId")
                        .HasColumnType("uuid");

                    b.HasKey("UserPostsId", "PostTagsTag", "PostTagsUserPostId");

                    b.HasIndex("PostTagsTag", "PostTagsUserPostId");
            ...
            modelBuilder.Entity("PostTagUserPost", b =>
                {
                    ...
                    b.HasOne("DAL.Entities.PostTag", null)
                        .WithMany()
                        .HasForeignKey("PostTagsTag", "PostTagsUserPostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
